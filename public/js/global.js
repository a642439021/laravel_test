...
{	   	
	...
	$("iframe.uploadframe").css("height","100%").css("width","100%").css("position","fixed").css("left","0px").css("top","0px").css("z-index","999999").show();
	$(window).resize(function(){
		$("iframe.uploadframe").css("height","100%").show();
	});
}
